...
var v = /* @__PURE__ */ t(((e) => {
...
})))(), x = ({ children: e, onClick: t, icon: n = _ }) => /* @__PURE__ */ (0, b.jsxs)("button", {
	onClick: t,
	...
	children: [/* @__PURE__ */ (0, b.jsxs)("span", {
		...
		children: [
			/* @__PURE__ */ (0, b.jsx)(n, { className: "w-4 h-4 text-blue-400" }),
			" ",
			e
		]
	}), /* @__PURE__ */ (0, b.jsx)("div", { className: "absolute top-0 left-0 w-full h-[2px] bg-blue-500 shadow-[0_0_15px_#3b82f6] -translate-y-full group-hover:animate-scan" })]
});
//#endregion
export { x as AtomicButton };
